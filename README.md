...
1. file   {.csv}:  file containing trial-wise subject responses (should follow tidy-data format) 
    ...
    <li> 'trialsIdx' is the trial indexes eg. 1...nTrials 
    <li> 'conditions' is a column with condition labels could be numerial or string or both 
    <li> 'accuracy' is the observer's correct (1) or incorrect (0) responses across trials                
